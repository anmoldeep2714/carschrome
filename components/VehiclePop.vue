...
const vehicleProps = defineProps({
    ...
    closeVehiclePop: Boolean,
    onPageSectionPop: Boolean,
})
...
const selectVehicle = () => {
    ...
    if (vehicleProps.reloadVehiclePop) {
        ...
        if(vehicleProps.closeVehiclePop){
            vehiclePopup.closePopup(vehicleProps.reloadVehiclePop);
        }
...
const closePopup = () =>{
    ...
    if(vehicleProps.reloadVehiclePop){
        /* vehiclePopup.closePopup(true); */
    }
    else{
        if(vehicleProps.closeVehiclePop){
            vehiclePopup.closePopup(false);
        }
    }
}
...
<template>
    <div v-if="vehiclePopup.showPopup || vehicleProps.onPageSectionPop" class="select-you-vehicle-section select-you-vehicle-popup">
        <div class="wrapper">
            <div class="inner">
                ...
                <div v-if="!showVehicleForm.loading && !showVehicleForm.show && selectedVehicles.length > 0"
                    ...
                    <div class="input-row">
                        <div class="input-column">
                            <div class="input-wrapper">
                                ...
                                <div class="active-text"> <span>{{ selectedVehicles ? selectedVehicles[0].year:'' }} </span> <span>{{ selectedVehicles ?
